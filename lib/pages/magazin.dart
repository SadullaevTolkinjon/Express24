...
class Magazinlar extends StatefulWidget {
  Map? malumot;
  Magazinlar({Key? key, this.malumot}) : super(key: key);

  @override
  _MagazinlarState createState() => _MagazinlarState();
}

class _MagazinlarState extends State<Magazinlar> {
  List<Jonatish> ls1 = [];
  @override
                        ...
                        child: Row(
                          children: [
                            Padding(
                                ...
                                child: Text(
                                    "Доставка ${widget.malumot!["dostavka"]} сум")),
                          ],
                        ),
                        height: 60.0,
                        width: 390,
              ...
              delegate: SliverChildBuilderDelegate((context, index) {
                return InkWell(
                  ...
                  onTap: () {
                    zakaz.add(
                      Jonatish(
                        narx: widget.malumot!["narx"][index],
                        nom: widget.malumot!["nom"],
                        rasm: widget.malumot!["turlirasm"][index],
                      ),
                    );
                    setState(() {});
                  },
